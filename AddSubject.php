...
echo '</br><tr><td class="visible">' . _('Subject Name') . ': </td>
			<td class="visible"><input tabindex="2" ' . (in_array('subject_name',$Errors) ?  'class="inputerror"' : '' ) .' type="Text" name="subject_name" value="' . $_POST['subject_name'] . '" size=40 maxlength=50 readonly=""></td></tr>
		<tr><td class="visible">' . _('Subject Code') . ': </td>
     <td class="visible"><input tabindex="3" ' . (in_array('subject_code',$Errors) ?  'class="inputerror"' : '' ) .' type="Text" name="subject_code" value="' . $_POST['subject_code'] . '" size=40 maxlength=50 readonly=""></td></tr>
