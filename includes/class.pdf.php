...
/* $Id: class.pdf.php 3678 2010-07-28 13:32:33Z tim_schofield $ */
	...
	protected function setuserpdffont() {
		...
		if (isset($_SESSION['PDFLanguage'])) {
			...
			switch ($userpdflang) {
				...
				case 1: $userpdffont = 'times';  break;
				case 2: $userpdffont = 'times';  break;
				case 3: $userpdffont = 'times';  break;
				case 4: $userpdffont = 'times';  break;
				case 5: $userpdffont = 'times';  break;
				case 6: $userpdffont = 'times';  break;
				case 7: $userpdffont = 'times';  break;
			}
...
function addText2($xb,$yb,$size,$text)//,$angle=0,$wordSpaceAdjust=0)
															{
// Javier	$text = html_entity_decode($text);
		$this->SetFontSize($size);
		$this->Text($xb-10, $this->h-$yb, $text);
	}
...
function addTextWrap2($xb, $yb, $w, $h, $txt, $align='J', $border=0, $fill=0) {
//		$txt = html_entity_decode($txt);
		$this->x = $xb;
		$this->y = $this->h*1.5 - $yb - $h;
