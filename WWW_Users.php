...
/* $Id: WWW_Users.php 4096 2010-10-13 09:13:10Z tim_schofield $*/
...
if (isset($SelectedUser)) {
	...
	echo '<table class=selection> <tr><td class ="visible">' . _('User code') . ':</td><td class ="visible">';
	echo $_POST['UserID'] . '</td></tr>';

} else { //end of if $SelectedUser only do the else when a new record is being entered

	echo '<table class=selection><tr><td class ="visible">' . _('User Login') . ":</td><td class =\"visible\"><input type='text' name='UserID' size=22 maxlength=20 ></td></tr>";
...
echo '<tr><td class ="visible">' . _('Reports Page Size') .":</td>
	<td class =\"visible\"><select name='PageSize'>";
...
echo '<tr>
	<td class ="visible">' . _('Language') . ":</td>
	<td class =\"visible\"><select name='UserLanguage'>";
...
foreach($ModuleList as $ModuleName){
	...
	echo '<tr><td class ="visible">' . _('Display') . ' ' . $ModuleName . ' ' . _('options') . ": </td><td class =\"visible\"><select name='Module_" . $i . "'>";
...
echo '<tr><td class ="visible">' . _('PDF Language Support') . ': </td><td class ="visible"><select name="PDFLanguage">';
for($i=0;$i<=7;$i++){
