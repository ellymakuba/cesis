...
/* $Id: Suppliers.php 4104 2010-10-22 04:40:14Z daintree $ */
...
Function Is_ValidAccount ($ActNo) {
	...
	if (!($BranchNumber >= 6500 and $BranchNumber <= 6599)) {
		echo _('National Kenyan branches must be between 6500 and 6599') . '. ' . _('The branch number used is invalid');
		return False;
		exit;
		}
		break;
	...
	echo _('The prefix') . ' - ' . $BankPrefix . ' ' . _('is not a valid New Zealand Bank') . '.<br>' .
			_('If you are using AIRADS System outside New Zealand error trapping relevant to your country should be used');
	return False;
	exit;
...
//SupplierID exists - either passed when calling the form or from the form itself
	...
	if (isset($_POST['New'])) {
		...
		echo "<br><p><div class='centre'><input type='Submit' name='submit' VALUE='" . _('Update Supplier') . "'><input type='Submit' name='delete' VALUE='" . _('Delete Supplier') . "' onclick=\"return confirm('" . _('Are you sure you wish to delete this supplier?') . "');\"></form>";
