...
$title = _('Write Off Item');

include('includes/header.inc');

echo '<p class="page_title_text">' . ' ' . _('Write Off Item') . '';   
...
$sql="UPDATE issued_products
				SET quantity_written_off=quantity_written_off+'" . $_POST['quantity'] . "',
				date_written_off='" . $_POST['date'] . "'
				WHERE id='" . $_SESSION['id'] . "'";
		$ErrMsg = _('The item could not be written off because');
		$result = DB_query($sql,$db,$ErrMsg);
		prnMsg( _('Item written off'),'success');
...
echo '<div class="centre"><input tabindex="7" type="Submit" name="issue" value="'. _('Write Off Item') .'"></div>';
