...
if (!isset($_POST['Show'])) {
	...
	echo '<tr><td>' . _('Transactions Dated') . ':</td>
		<td><input type="text" name="TransDate" alt="'.$_SESSION['DefaultDateFormat'].'" maxlength=10 size=11
	...
	$sql="SELECT banktrans.*,
				...
				systypes.typename,
				systypes.typeid,
				debtorsmaster.name as student_name,
			...
			ON banktrans.transno=debtortrans.transno
			LEFT JOIN debtorsmaster
			ON debtorsmaster.id=debtortrans.debtorno
