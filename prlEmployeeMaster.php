	...
	//	$SQL_SupplierSince = FormatDateForSQL($_POST['SupplierSince']);
		if (!isset($_POST['New'])) {
				$sql = "UPDATE prlemployeemaster SET
					...
					ssnumber='" . DB_escape_string($_POST['NSSF']) . "',
					PAYEnumber='" . DB_escape_string($_POST['PAYE']) . "',
					phnumber='" . DB_escape_string($_POST['NHIF']) . "',
			...
			prnMsg(_('The employee master record for') . ' ' . $EmployeeID . ' ' . _('has been updated'),'success');
				...
				VALUES ('$EmployeeID', 
					...
					'" . DB_escape_string($_POST['bankname']) . "',
					'" . DB_escape_string($_POST['bankcode']) . "',
					'" . DB_escape_string($_POST['ATM']) . "',
					'" . DB_escape_string($_POST['TAN']) . "',
					'" . DB_escape_string($_POST['NSSF']) . "',
					'" . DB_escape_string($_POST['PAYE']) . "',
					'" . DB_escape_string($_POST['NHIF']) . "',
					'" .$SQL_BirthDate. "',
					'" . $_POST['Marital'] . "',				
					'" . $_POST['Gender'] . "',				
					'" . $_POST['TaxStatusID'] . "',				
...
echo '<input type="hidden" name="FormID" value="' . $_SESSION['FormID'] . '" />';
	...
	echo '<TR><TD width=200 height=20><div align="right"><b>' . _('Town') . ":</TD><TD><input type='Text' name='City' SIZE=42 MAXLENGTH=40></TD></TR>";			
	...
	echo '<TR><TD width=200 height=20><div align="right"><b>' . _('Bank Name') . ":</TD><TD><input type='Text' name='bankname' SIZE=42 MAXLENGTH=40></TD></TR>";
	echo '<TR><TD width=200 height=20><div align="right"><b>' . _('Bank Code') . ":</TD><TD><input type='Text' name='bankcode' SIZE=42 MAXLENGTH=40></TD></TR>";		
	echo '<TR><TD width=200 height=20><div align="right"><b>' . _('ATM Number') . ":</TD><TD><input type='Text' name='ATM' SIZE=22 MAXLENGTH=20></TD></TR>";		
	echo '<TR><TD width=200 height=20><div align="right"><b>' . _('PIN Number') . ":</TD><TD><input type='Text' name='TAN' SIZE=22 MAXLENGTH=20></TD></TR>";		
	echo '<TR><TD width=200 height=20><div align="right"><b>' . _('NSSF Number') . ":</TD><TD><input type='Text' name='NSSF'  SIZE=22 MAXLENGTH=20></TD></TR>";		
	echo '<TR><TD width=200 height=20><div align="right"><b>' . _('NHIF Number') . ":</TD><TD><input type='Text' name='NHIF' SIZE=22 MAXLENGTH=20></TD></TR>";		
	?>
	       <tr> 
...
echo '<input type="hidden" name="FormID" value="' . $_SESSION['FormID'] . '" />';
	echo '<CENTER><TABLE>';
		...
		$_POST['NSSF']  = $myrow['ssnumber'];
		$_POST['PAYE']  = $myrow['PAYEnumber'];
		$_POST['NHIF']  = $myrow['phnumber'];
	...
	echo '<TR><TD width=200 height=20><div align="right"><b>' . _('Town') . ":</TD><TD><input type='Text' name='City' value='" . $_POST['City'] . "' SIZE=42 MAXLENGTH=40></TD></TR>";			
	...
	echo '<TR><TD width=200 height=20><div align="right"><b>' . _('Bank Name') . ":</TD><TD><input type='Text' name='bankname' value='" . $_POST['bankname'] . "' SIZE=42 MAXLENGTH=40></TD></TR>";
	echo '<TR><TD width=200 height=20><div align="right"><b>' . _('Bank Code') . ":</TD><TD><input type='Text' name='bankcode' value='" . $_POST['bankcode'] . "' SIZE=42 MAXLENGTH=40></TD></TR>";		
	...
	echo '<TR><TD width=200 height=20><div align="right"><b>' . _('PAYE Account Number') . ":</TD><TD><input type='Text' name='TAN' value='" . $_POST['TAN'] . "' SIZE=22 MAXLENGTH=20></TD></TR>";		
	echo '<TR><TD width=200 height=20><div align="right"><b>' . _('NSSF Number') . ":</TD><TD><input type='Text' name='NSSF' value='" . $_POST['NSSF'] . "' SIZE=22 MAXLENGTH=20></TD></TR>";		
	
	echo '<TR><TD width=200 height=20><div align="right"><b>' . _('NHIF Number') . ":</TD><TD><input type='Text' name='NHIF' value='" . $_POST['NHIF'] . "' SIZE=22 MAXLENGTH=20></TD></TR>";		
