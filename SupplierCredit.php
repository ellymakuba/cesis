...
/* $Id: SupplierCredit.php 4002 2010-09-30 15:44:30Z tim_schofield $ */
...
echo '<div class="centre"><p class="page_title_text"><img src="'.$rootpath.'/css/'.$theme.'/images/transactions.png" title="' . _('Supplier Credit Note') . '" alt="">' . ' '
...
/*Now retrieve supplier information - name, currency, default ex rate, terms, tax rate etc */
	...
	if(DB_num_rows($LocalTaxProvinceResult)==0){
		prnMsg(_('The tax associated with your user account has not been set up in this database. Tax calculations are based on the tax group of the supplier and the tax of the user entering the invoice. The system administrator should redefine your account with a valid default stocking location and this location should refer to a valid tax'),'error');
...
echo "<table class=selection colspan=4><tr><th>" . _('Supplier') . "</th>
				<th>" . _('Currency') . "</th>
				<th>" . _('Terms') . "</th>
