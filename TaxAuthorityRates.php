<?php
/* $Id: TaxAuthorityRates.php 4014 2010-09-30 16:07:37Z tim_schofield $*/
...
if (DB_num_rows($TaxRatesResult)>0){
	...
	$TableHeader = '<tr><th>' . _('Deliveries From') . '<br>' . _('Tax') . '</th>
...
echo "<br><div class='centre'><input type=submit name='UpdateRates' VALUE='" . _('Update Rates') . "'>";
	...
	prnMsg(_('There are no tax rates to show - perhaps the dispatch tax records have not yet been created?'),'warn');
}
...
echo '<br><a href="' . $rootpath . '/TaxProvinces.php?' . SID . '">' . _('Dispatch Tax') .  '</a>';
echo '</div>';
