...
echo '<input type="hidden" name="FormID" value="' . $_SESSION['FormID'] . '" />';
	echo '<CENTER><TABLE>';
		...
		$FSYear  = $myrow['fsyear'];	
		$NSSF  = GetYesNoStr($myrow['deductsss']);
		$PAYE = GetYesNoStr($myrow['deductPAYE']);
		$NHIF  = GetYesNoStr($myrow['deductphilhealth']);
	...
	echo '<CENTER>' ."<INPUT TYPE=SUBMIT NAME='Close' VALUE='" . _('Close Payroll Period') . "'><INPUT TYPE=SUBMIT NAME='Purge' VALUE='" . _('Purge Payroll Period') . "'><HR>";
	echo "<INPUT TYPE=SUBMIT NAME='Generate' VALUE='" . _('Generate Payroll Data') . "'><INPUT TYPE=SUBMIT NAME='Reopen' VALUE='" . _('Re-open Payroll Period') . "'><HR>";
  ...
  <tr> 
    <td height="180" valign="top"> 
      ...
      <table width="90%" border="1" cellspacing="0" cellpadding="0" align="center" bordercolordark="#CCCCCC" bordercolorlight="#CCCCCC" bgcolor="#F2F2F2">
        ...
        <tr bgcolor="#F4F4F4"> 
          <td height="30" width="26%"> 
            <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">Deduct NSSF 
              :</font></div>
          </td>
          <td height="30" width="74%"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><b><?php echo $NSSF; ?></a></b></font></td>
        </tr>
        <tr bgcolor="#F4F4F4"> 
          <td height="30" width="26%"> 
            <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">Deduct Welfare
              :</font></div>
          </td>
          <td height="30" width="74%"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><b><?php echo $PAYE; ?></a></b></font></td>
        </tr>
        <tr bgcolor="#F4F4F4"> 
          <td height="30" width="26%"> 
          ...
          <td height="30" width="74%"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><b><?php echo $NHIF; ?></a></b></font></td>
        </tr>
        <tr bgcolor="#F4F4F4"> 
          <td height="30" width="26%"> 
