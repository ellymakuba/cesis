...
/* $Id: GLAccountInquiry.php 3892 2010-09-30 14:58:05Z tim_schofield $*/
/* $Revision: 1.28 $ */
...
if (isset($_POST['Show'])){
	...
	while ($myrow=DB_fetch_array($TransResult)) {
		...
		$tagrow = DB_fetch_array($tagresult);
		 echo "<td>"."<a href ='" . $rootpath ."/PDFPaymentVoucher.php?"."&acccountid=" . $myrow['counterindex']. "'>". _('Print') ."</a>"."</td>";
		printf("<td>%s</td>
