...
$msg='';
echo '<p class="page_title_text">' . ' ' . _('Deregister student subjects') . '';
...
exit();
			...
			<?php
		echo "<tr><td class=\"visible\"><Input type = 'Checkbox' name ='add_id[]' value='".$row['calendar_id']."'>".$row['debtorno']."</td>";
