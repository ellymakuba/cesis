...
function set_calendar_vars_stream_exam_mode($calendar_id,$db) {
...
class bus_report_stream_exam_mode {
	...
	function get_scheduled_students_stream_exam_mode($class,$period,$exam_mode,$db) {
		...
		$sql = "select rs.id,dm.name, rs.student_id,er.rank,er.marks,h.initial 
		from registered_students rs,studentsmarks sm,debtorsmaster dm,classes cls,houses h,exam_ranks er
