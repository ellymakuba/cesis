<?php
/* $Id: api_customers.php 3369 2010-03-05 10:47:19Z lindsayh $*/
...
/* Check that the currency code is set up in the AIRADS System database */
...
/* Check that the sales type is set up in the AIRADS System database */
...
/* Check that the hold reason is set up in the AIRADS System database */
...
/* Check that the payment terms are set up in the AIRADS System database */
...
/* Check that the customer type is set up in the AIRADS System database */
...
/* Insert a new customer in the AIRADS System database. This function takes an
...
/* Modifies a customer record in the AIRADS System database. This function takes an
   associative array called $CustomerDetails, where the keys are the
   names of the fields in the debtorsmaster table, and the values are the
