<?php
/* $Id: api_salesorders.php 3351 2010-02-18 06:09:20Z lindsayh $*/
...
/* Check that the order type is set up in the AIRADS System database */
...
/* Check that the from stock location is set up in the AIRADS System database */
