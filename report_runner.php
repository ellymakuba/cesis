...
// AIRADS System. Much thanks to Phil Daintree as the major author of AIRADS System.
//
// --------------------------------------------------------------------
// Written by Alan B Jones (mor3ton@yahoo.com)
// based on code orgiginally from AIRADS System
// (c) alan jones 2006.
...
//$AIRADS System_home=/srv/www/htdocs/AIRADS System
/* $Id: report_runner.php 3384 2010-03-13 16:22:42Z tim_schofield $*/

$usage="USAGE\n".$argv[0].":\n".
       "     -r reportnumber (the number of the AIRADS System report)\n".
       ...
       "     [ -H weberpHOME]  (the home directory for AIRADS System - or edit the php file)\n";
...
if ($weberp_home=="") {
 	echo "AIRADS System home is not set in this file or -H isn't set";
}
// change directory to the AIRADS System home to get all the includes to work nicely
chdir($weberp_home);
