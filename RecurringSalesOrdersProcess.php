<?php
/* $Id: RecurringSalesOrdersProcess.php 3756 2010-09-23 10:42:37Z tim_schofield $*/

/*need to allow this script to run from Cron or windows scheduler */
$AllowAnyone = true;

/* Get this puppy to run from cron (cd AIRADS System && php -f RecurringSalesOrdersProcess.php "airads") or direct URL (RecurringSalesOrdersProcess.php?Database=airads) */
...
//		$CustTaxAuth = $myrow[2];
		...
		$ErrMsg = _('Could not retrieve the tax of the location from where the order was fulfilled because:');
		$Result = DB_query($SQL,$db,$ErrMsg);
		$myrow=DB_fetch_row($Result);
